...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Kid Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Kid Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Kid Editor Preview Instance Running",
        ReleaseChannel::Stable => "Kid Editor Stable Instance Running",
    }
}
