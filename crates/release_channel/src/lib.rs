...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "Kid Dev",
            ReleaseChannel::Nightly => "Kid Nightly",
            ReleaseChannel::Preview => "Kid Preview",
            ReleaseChannel::Stable => "Kid",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.kid.Kid-Dev",
            ReleaseChannel::Nightly => "dev.kid.Kid-Nightly",
            ReleaseChannel::Preview => "dev.kid.Kid-Preview",
            ReleaseChannel::Stable => "dev.kid.Kid",
        }
    }
